        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card shadow">
                    <div class="card-header bg-warning text-dark">Editar Alumno</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('fecha_ingreso', $alumno->fecha_ingreso) }}" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('matricula') is-invalid @enderror"
                                                ...
                                                value="{{ old('matricula', $alumno->matricula) }}" required>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('seccion_id') is-invalid @enderror"
                                                ...
                                                @foreach($secciones as $seccion)
                                                    <option value="{{ $seccion->id }}" {{ $alumno->seccion_id == $seccion->id ? 'selected' : '' }}>{{ $seccion->nombre }} - {{ $seccion->turno }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('localidad') is-invalid @enderror"
                                                ...
                                                value="{{ old('localidad', $alumno->localidad) }}" required>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01"
                                                    ...
                                                    value="{{ old('valor_cuota', $alumno->valor_cuota) }}" required>
                                            </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" step="0.01"
                                                ...
                                                id="bonificacion" name="bonificacion"
                                                value="{{ old('bonificacion', $alumno->bonificacion) }}" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea class="form-control" id="hermanos" name="hermanos"
                                                rows="3">{{ old('hermanos', $alumno->hermanos) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
